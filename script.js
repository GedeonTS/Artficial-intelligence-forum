...
const HSdata = [{ HideShow: 'MORE', DownUp: '<i class="material-icons ">keyboard_arrow_down</i>' }, { HideShow: 'LESS', DownUp: '<i class="material-icons ">keyboard_arrow_up</i>' }]

// HideShow = HSdata[0].HideShow;
// DownUp = HSdata[0].DownUp;
...
var textBtn2 = document.createElement('div');
...
var textBtn22 = document.createElement('div');
